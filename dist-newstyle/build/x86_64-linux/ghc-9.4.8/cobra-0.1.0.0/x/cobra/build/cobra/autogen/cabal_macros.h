...
/* package cobra-0.1.0.0 */
#ifndef VERSION_cobra
#define VERSION_cobra "0.1.0.0"
#endif /* VERSION_cobra */
#ifndef MIN_VERSION_cobra
#define MIN_VERSION_cobra(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_cobra */
...
#define CURRENT_COMPONENT_ID "cobra-0.1.0.0-inplace-cobra"
